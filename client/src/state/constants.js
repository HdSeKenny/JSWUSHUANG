...
export const ACTIONS = {
  ...
  // gang admin
  GET_GANG_ADMINS_SUCCESS: 'GET_GANG_ADMINS_SUCCESS',
  ADD_GANG_ADMIN_SUCCESS: 'ADD_GANG_ADMIN_SUCCESS',
  UPDATE_GANG_ADMIN_SUCCESS: 'UPDATE_GANG_ADMIN_SUCCESS',
  DELETE_GANG_ADMIN_SUCCESS: 'DELETE_GANG_ADMIN_SUCCESS'
}
